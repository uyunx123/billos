      ...
      <div className="grid gap-8 lg:grid-cols-2">
        <div>
                  ...
                  <li key={s.id}>
                    ...
                    >
                      <div className="flex items-start justify-between gap-3">
                        <span className="grid h-11 w-11 place-items-center rounded-2xl bg-primary/10 text-primary-400">
                      ...
                      <span className="mt-3 inline-flex items-center gap-1.5 text-sm font-bold text-primary-400 transition-colors group-hover:text-gold-300">
          ...
          <div className="card mt-4 p-6">
            ...
            {sent ? (
              <p className="mt-4 flex items-start gap-2.5 rounded-xl bg-gradient-to-r from-primary-50 to-primary-100/60 px-4 py-3.5 text-sm font-semibold text-primary-400 ring-1 ring-primary-200">
