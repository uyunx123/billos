        ...
        <div className="space-y-8">
          <section className="card p-6">
            ...
            <div className="mt-5 border-t border-border pt-5">
              ...
              {showMap && (
                <Suspense fallback={<div className="grid h-64 place-items-center rounded-2xl border border-border bg-foreground/10 text-sm text-foreground/50">Loading map…</div>}>
                  <AddressMapPicker
