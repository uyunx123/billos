      ...
      <div className="relative overflow-hidden rounded-3xl border border-border bg-surface-2 px-6 py-10 shadow-soft sm:px-10">
        ...
        <div className="relative flex flex-col items-start justify-between gap-6 sm:flex-row sm:items-center">
          ...
          <div className="flex flex-wrap items-center gap-2">
            {isAdmin && (
              <span className="rounded-full bg-primary/10 px-3 py-1 text-xs font-bold text-primary-400 ring-1 ring-primary/30">
        ...
        {rows.map((row) => {
          ...
          return (
            <div key={row.label} className="card p-5">
              ...
              >
                <span className="mb-3 inline-flex h-9 w-9 items-center justify-center rounded-xl bg-primary/10 text-primary-400">
