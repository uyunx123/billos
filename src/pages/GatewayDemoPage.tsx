...
export default function GatewayDemoPage() {
  ...
  return (
    <div className="mx-auto max-w-xl px-4 py-12 sm:py-16">
      <p className="flex items-center justify-center gap-1.5 text-[11px] font-bold uppercase tracking-[0.22em] text-primary-400">
        ...
        {manual ? (
          <div className="mt-4 rounded-2xl border border-border bg-surface-2 p-5">
            <div className="flex items-center gap-3">
              <span className="grid h-11 w-11 shrink-0 place-items-center rounded-xl bg-primary/10 text-primary-400 ring-1 ring-primary/15">
              ...
              <dl className="mt-4 space-y-2 rounded-xl bg-foreground/10 p-4 text-sm">
                ...
                {manual.accountNumber && (
                  <div className="flex justify-between gap-3">
                    ...
                    <dd className="font-heading text-base font-bold tracking-wide text-primary-400">{manual.accountNumber}</dd>
                  </div>
                )}
              </dl>
            )}
          ...
          <div className="mt-4 flex items-center gap-3 rounded-2xl bg-gradient-to-br from-primary-50 to-primary-100 p-4 ring-1 ring-primary/15">
            <span className="grid h-11 w-11 shrink-0 place-items-center rounded-xl bg-surface-2 text-primary-400 shadow-soft ring-1 ring-primary/10">
              <ChannelIcon className="h-5 w-5" aria-hidden="true" />
            </span>
            <div className="min-w-0">
